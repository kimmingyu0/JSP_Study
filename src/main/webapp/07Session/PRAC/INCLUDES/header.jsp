...
<header>
    ...
    <div id="loginwin" class="p-3">
        ...
        <form action="01LoginProc.jsp" method="post">
            <input placeholder="Insert ID" name="userid" class="form-control mb-3"><br>
            <input placeholder="Insert PW" name="pwd" class="form-control mb-3"><br>
